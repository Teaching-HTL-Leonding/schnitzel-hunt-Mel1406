...
int GetDishPrice(string line) => int.Parse(line[(line.IndexOf(":") + 2)..^1]);

string GetDishName(string line) => line[0..line.IndexOf(":")];

void FindWhereLeastToPay(string[] lines,
                   string searchText,
                   string pathFile,
                   ref int[] prices,
                   ref string[] restaurants,
